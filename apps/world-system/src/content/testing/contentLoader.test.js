...
function runContentLoaderTests() {
  ...
  runTest("starter_spells_include_minimum_caster_slice", () => {
    ...
    assert.equal(Boolean(byId.true_strike), true);
    ...
    assert.equal(byId.true_strike.metadata.runtime_support.combat_resolution, "supported");
  ...
  runTest("spell_library_includes_non_alpha_srd_import_entries", () => {
    ...
    assert.equal(byId.chain_lightning.metadata.alpha_selectable, true);
    assert.equal(byId.chain_lightning.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.mass_cure_wounds.metadata.alpha_selectable, true);
      assert.equal(byId.mass_cure_wounds.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.heal.metadata.alpha_selectable, true);
      assert.equal(byId.heal.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.mass_heal.metadata.alpha_selectable, true);
      assert.equal(byId.mass_heal.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.greater_restoration.metadata.alpha_selectable, true);
      assert.equal(byId.greater_restoration.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.remove_curse.metadata.alpha_selectable, true);
      assert.equal(byId.remove_curse.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.hold_monster.metadata.alpha_selectable, true);
      assert.equal(byId.hold_monster.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.haste.metadata.alpha_selectable, true);
    assert.equal(byId.haste.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.sleet_storm.metadata.alpha_selectable, true);
    assert.equal(byId.sleet_storm.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.slow.metadata.alpha_selectable, true);
    assert.equal(byId.slow.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.gust_of_wind.metadata.alpha_selectable, true);
    assert.equal(byId.gust_of_wind.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.fog_cloud.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.darkness.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.shillelagh.metadata.alpha_selectable, true);
    assert.equal(byId.shillelagh.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.stinking_cloud.metadata.alpha_selectable, true);
    assert.equal(byId.stinking_cloud.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.cloudkill.metadata.alpha_selectable, true);
    assert.equal(byId.cloudkill.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.spike_growth.metadata.alpha_selectable, true);
    assert.equal(byId.spike_growth.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.ice_storm.metadata.alpha_selectable, true);
    assert.equal(byId.ice_storm.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.greater_invisibility.metadata.alpha_selectable, true);
    assert.equal(byId.greater_invisibility.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.stoneskin.metadata.alpha_selectable, true);
    assert.equal(byId.stoneskin.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.protection_from_energy.metadata.alpha_selectable, true);
      assert.equal(byId.protection_from_energy.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.true_strike.metadata.alpha_selectable, true);
      assert.equal(byId.true_strike.metadata.runtime_support.combat_resolution, "supported");
      assert.equal(byId.color_spray.metadata.alpha_selectable, true);
      assert.equal(byId.color_spray.effect.hp_pool_formula, "6d10");
    assert.equal(byId.death_ward.metadata.alpha_selectable, true);
    assert.equal(byId.death_ward.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.expeditious_retreat.metadata.alpha_selectable, true);
    assert.equal(byId.expeditious_retreat.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.sleep.metadata.alpha_selectable, true);
    assert.equal(byId.sleep.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.power_word_stun.metadata.alpha_selectable, true);
    assert.equal(byId.power_word_stun.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.power_word_kill.metadata.alpha_selectable, true);
    assert.equal(byId.power_word_kill.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.hypnotic_pattern.metadata.alpha_selectable, true);
    assert.equal(byId.hypnotic_pattern.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.calm_emotions.metadata.alpha_selectable, true);
    assert.equal(byId.calm_emotions.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.banishment.metadata.alpha_selectable, true);
    ...
    assert.equal(byId.holy_aura.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.foresight.metadata.alpha_selectable, true);
    assert.equal(byId.foresight.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.disintegrate.metadata.alpha_selectable, true);
    assert.equal(byId.disintegrate.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.harm.metadata.alpha_selectable, true);
    assert.equal(byId.harm.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.feeblemind.metadata.alpha_selectable, true);
    assert.equal(byId.feeblemind.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.sunburst.metadata.alpha_selectable, true);
    assert.equal(byId.sunburst.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.insect_plague.metadata.alpha_selectable, true);
    assert.equal(byId.insect_plague.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.incendiary_cloud.metadata.alpha_selectable, true);
    assert.equal(byId.incendiary_cloud.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.fire_storm.metadata.alpha_selectable, true);
    assert.equal(byId.fire_storm.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.flame_strike.metadata.alpha_selectable, true);
    assert.equal(byId.flame_strike.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.meteor_swarm.metadata.alpha_selectable, true);
    assert.equal(byId.meteor_swarm.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.flesh_to_stone.metadata.alpha_selectable, true);
    assert.equal(byId.flesh_to_stone.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.globe_of_invulnerability.metadata.alpha_selectable, true);
    assert.equal(byId.globe_of_invulnerability.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.guardian_of_faith.metadata.alpha_selectable, true);
    assert.equal(byId.guardian_of_faith.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.wall_of_force.metadata.alpha_selectable, true);
    assert.equal(byId.wall_of_force.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.confusion.metadata.alpha_selectable, true);
    assert.equal(byId.confusion.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.wind_wall.metadata.alpha_selectable, true);
    assert.equal(byId.wind_wall.metadata.runtime_support.combat_resolution, "supported");
    assert.equal(byId.wall_of_fire.metadata.alpha_selectable, false);
