...
function handleCombatCommandDispatch(event, context) {
  ...
  if (requestEvent.event_type === EVENT_TYPES.PLAYER_CAST_SPELL) {
    ...
    return [createGatewayResponseEvent(requestEvent, "cast", {
      ...
      hazard_side: castSpell.hazard_side || (requestEvent.payload && requestEvent.payload.hazard_side) || null,
      ...
      active_effects_added: Array.isArray(castSpell.active_effects_added) ? clone(castSpell.active_effects_added) : [],
